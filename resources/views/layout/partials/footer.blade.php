<footer>
    <div class="title-footer">Formations</div>
    <ul>
        <li><a href="">Nos formations</a></li>
        <li><a href="">Composantes</a></li>
        <li><a href="">Stuffs</a></li>
    </ul>
    <div class="title-footer">Tutoriels</div>
    <ul>
        <li><a href="">Modset</a></li>
        <li><a href="/tutos">Nos tutos</a></li>
    </ul>
    <div class="title-footer">Partenaires</div>
    <ul>
        <li>
            <a target="-blank" href="https://www.polygames.net/">
            Polygames</a>
        </li>
        <li>
            <a target="-blank" href="https://arma3.com/">
            Arma Bohemia</a>
        </li>
        <li>
            <a target="-blank" href="https://www.gsri.team/">
            GSRI</a>
        </li>
        <li>
            <a target="-blank" href="https://grecedecanards.fr/">
            Grèce de Canard</a>
        </li>
        <li>
            <a href="">Twitch</a>
    ...
    <ul class="sociaux">
        <li>
            <a target="-blank" href="ts3server://ts3.Polygames.net?password=alphatest">
            <i class="fab fa-teamspeak"></i></a>
        </li>
        <li>
            <a target="-blank" href="https://discord.gg/AmWBzqV">
        ...
        <li>
            <a target="-blank" href="https://www.youtube.com/channel/UCZjaHyQVKI6TquGXwuFfkAw">
            <i class="fab fa-youtube"></i></a>
        </li>
        <li>
            <a target="-blank" href="https://www.facebook.com/GieMilsim/">
